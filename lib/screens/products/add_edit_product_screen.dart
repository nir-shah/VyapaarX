      ...
      body: SafeArea(
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              AppSectionTitle(
                title: _isEditing ? 'Product details' : 'New product',
                subtitle:
              ...
              _ProductFormSection(
                ...
                children: [
                  ...
                  AppTextField(
                    ...
                    validator: (value) =>
                        Validators.requiredText(value, fieldName: 'Barcode'),
                  ),
                  const SizedBox(height: AppSpacing.md),
                  AppTextField(
                    label: 'HSN code',
...
class _ProductFormSection extends StatelessWidget {
  const _ProductFormSection({required this.title, required this.children});
